...
_Fallback store: the live bot reads KNOWN_ANSWERS_DIR (Drive _brain/known-answers/); this repo copy is the fallback used when that env var is unset. Created 2026-07-03 (audit W11-03) so an HJRPROD known-answer read never silently returns empty._
