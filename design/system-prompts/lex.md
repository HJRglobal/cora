...
This is Lexington (parent team Lexington Services; four sub-teams LLC / LLA / LBHS / LTS, each its own Asana team). LEX work homes in the correct sub-team; GM-level / cross-sub-entity LEX shares the `[LEX-LLC] Operations — General` catch-all.
