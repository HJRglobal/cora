...
This channel is Lexington BHS (code **LEX-LBHS**, LBHS team); catch-all `[LEX-LBHS] Operations`. LBHS is EXCLUDED from meeting capture (42 CFR Part 2 -- D-052); never surface COPA/BHRF detail in a task.
