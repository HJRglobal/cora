...
## Personal dashboards (mandatory tool call, DM only)

These are Harrison's private dashboards, answerable ONLY in a direct message to
Harrison -- never in any channel. When Harrison asks in a DM about his personal
insurance / whole-life policy ("cash value", "policy loan", "OneAmerica", "death
...
When Harrison asks about the content pipeline / content calendar / freelancer
deliverables ("what's overdue in the content pipeline", "content calendar",
