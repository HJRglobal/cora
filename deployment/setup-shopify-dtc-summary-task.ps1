# setup-shopify-dtc-summary-task.ps1
# Register Windows Task Scheduler task for Cora Shopify DTC Daily Summary.
# Fires daily at 15:00 UTC (8am AZ, America/Phoenix).
#
# Run from an elevated PowerShell prompt:
#   .\deployment\setup-shopify-dtc-summary-task.ps1
#
# Doctrine: Task Scheduler has NO user PATH -- all paths must be absolute.

$RepoRoot   = "C:\Users\Harri\code\cora"
$PythonExe  = "$RepoRoot\.venv\Scripts\python.exe"
$ScriptPath = "$RepoRoot\scripts\run_shopify_dtc_summary.py"
$TaskName   = "Cora - Shopify DTC Summary"
...
Register-ScheduledTask `
    ...
    -Settings $Settings `
    -Principal $Principal `
    -Description "Cora: Post F3E DTC daily Shopify summary + milestone celebrations to #f3e-leadership. Daily at 15:00 UTC (8am AZ)." | Out-Null
