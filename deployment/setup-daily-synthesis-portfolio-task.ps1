# Setup Windows Scheduled Task: Cora daily Portfolio synthesis, 06:31 AZ.
#
...
# Portfolio synthesis to #founder-operations.
#
...
#
# Slot check (2026-07-07, verified against the live registry): 06:31 AZ is a free
...
#     .\deployment\setup-daily-synthesis-portfolio-task.ps1
#
# To remove:
#     Unregister-ScheduledTask -TaskName 'Cora - Daily Synthesis (Portfolio)' -Confirm:$false

$ErrorActionPreference = "Stop"

$RepoRoot   = "C:\Users\Harri\code\cora"
$PythonExe  = "C:\Users\Harri\code\cora\.venv\Scripts\python.exe"
$TaskName   = "Cora - Daily Synthesis (Portfolio)"
$ScriptPath = "C:\Users\Harri\code\cora\scripts\run_portfolio_synthesis.py"
$HourMin    = "06:31"
...
$action = New-WrappedTaskAction -TaskName 'Cora - Daily Synthesis (Portfolio)' `
    -Execute $PythonExe `
    -Argument "`"$ScriptPath`"" `
...
Register-ScheduledTask `
    -TaskName $TaskName `
    -Description "holdco operations synthesis (cash across entities, pipeline, deadline radar, stalled P0/P1) to #founder-operations; operational-only" `
    -Action $action `
    -Trigger $trigger `
    -Principal $principal `
