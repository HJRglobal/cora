# Setup Windows Scheduled Task: Cora daily HJRP synthesis, 06:35 AZ.
#
...
# HJRP synthesis to #hjrp-leadership.
#
...
#
# Slot check (2026-07-07, verified against the live registry): 06:35 AZ is a free
...
#     .\deployment\setup-daily-synthesis-hjrp-task.ps1
#
# To remove:
#     Unregister-ScheduledTask -TaskName 'Cora - Daily Synthesis (HJRP)' -Confirm:$false

$ErrorActionPreference = "Stop"

$RepoRoot   = "C:\Users\Harri\code\cora"
$PythonExe  = "C:\Users\Harri\code\cora\.venv\Scripts\python.exe"
$TaskName   = "Cora - Daily Synthesis (HJRP)"
...
$action = New-WrappedTaskAction -TaskName 'Cora - Daily Synthesis (HJRP)' `
    -Execute $PythonExe `
    -Argument "`"$ScriptPath`" --entity hjrp" `
...
Register-ScheduledTask `
    -TaskName $TaskName `
    -Description "HJR Properties operational synthesis (cash, deadlines, decisions) to #hjrp-leadership" `
    -Action $action `
    -Trigger $trigger `
    -Principal $principal `
...
Write-Host "  & '$PythonExe' '$ScriptPath' --entity hjrp --dry-run"
