...
#
# Removes the cowork-cora-backup scheduled task from Task Scheduler.
# Does NOT affect the cowork-cora-service (bot) or cowork-cora-digest tasks.
#
# Usage:
#   powershell -ExecutionPolicy Bypass -File "C:\Users\Harri\code\cora\deployment\remove-backup-task.ps1"
...
Write-Host ""
Write-Host "=== Cora Backup Task Removal ==="
Write-Host ""
