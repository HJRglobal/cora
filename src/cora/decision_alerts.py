...
def build_close_preview(rec: dict, answer: str) -> str:
    ...
    return (
        ...
        f"Confirm records it against this decision and stops the daily alert "
        f"re-asking you. It does NOT edit `decisions-pending.md` -- that stays "
        f"your edit (D-011). I'll include the wording in the next cascade "
        f"proposal."
    )
