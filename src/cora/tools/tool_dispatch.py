...
TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "you read'. Connector-ACCESS questions ARE answered here too ('can you access "
            "HubSpot / Asana / QBO / the calendar / Shopify?'): the LIVE TOOL CONNECTORS line "
            "lists the systems you reach through tools in this channel -- they are NOT "
            "knowledge-base sources, so a listed connector is answered YES via that tool, never "
            "'not in my sources'. NOT for USING a connector (a tool-use ask such as 'check my "
            "calendar for Friday' -- call that tool) and NOT for content questions ('do you "
            "have the EVV docs' -- retrieval answers that). A knowledge-"
